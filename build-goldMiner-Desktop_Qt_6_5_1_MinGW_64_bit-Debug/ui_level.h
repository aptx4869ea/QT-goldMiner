...
public:
    ...
    void setupUi(QWidget *Level)
    {
        ...
        minerLabel->setGeometry(QRect(320, 10, 91, 81));
        ...
        backgroundWidget->setStyleSheet(QString::fromUtf8("#backgroundWidget{background-image: url(\"../goldMiner/Images/background.png\");}\n"
""));
